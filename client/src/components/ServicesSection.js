    ...
    <section className="container py-5">
      <div className="row text-center pt-5 pb-3">
        <div className="col-lg-6 m-auto">
          ...
          <p>
          Our services include fast and reliable shipping, ensuring that your orders are delivered 
          to your doorstep in a timely manner. We also provide secure and hassle-free payment options, 
          allowing you to shop with confidence and peace of mind.
          </p>
        </div>
      </div>
      <div className="row">
